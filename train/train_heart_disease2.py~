...
def train_and_evaluate():
    ...
    tree = build_tree(X_temp, y_temp, attribute_types)
    ...
    tree_pruned = prune_tree(deepcopy(tree), X_test, y_temp, attribute_types)
    ...
    forest.fit(X_temp, y_temp, attribute_types)  # Используем всю тренировочную часть без теста
    ...
    forest.trees = [
        prune_tree(tree, X_test, y_test, attribute_types)
